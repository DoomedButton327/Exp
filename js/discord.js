...
function buildEmbed(p) {
  ...
  switch (p.type) {
    ...
    case 'result':
      return {
        ...
        fields: [
          ...
          { name: 'Score', value: `${p.homeGoals} – ${p.awayGoals}`, inline: true },
    ...
    case 'autoForfeit':
      return {
        ...
        fields: [
          ...
          { name: 'Match', value: `${p.home} vs ${p.away}`, inline: true },
          { name: 'Result', value: `${p.winner} wins 3–0`, inline: true },
        ],
        timestamp: ts,
      };
    ...
    case 'forfeit':
      return {
        ...
        fields: [
          ...
          { name: 'Winner', value: `${p.winner} — 3–0`, inline: true },
        ],
        timestamp: ts,
      };
    ...
    case 'noshow':
      return {
        ...
        fields: [
          ...
          { name: 'Result', value: `${p.reporter} wins 3–0`, inline: true },
        ],
        timestamp: ts,
      };
    ...
    case 'catchup':
      return {
        color: p.catchup ? 0x38bdf8 : 0x34c759,
        title: p.catchup ? '🔵 Player Flagged for Catch-up' : '🟢 Catch-up Cleared',
        description: `**${p.player}** has been ${p.catchup ? 'flagged as needing a catch-up game' : 'cleared from catch-up'}.`,
        timestamp: ts,
      };
